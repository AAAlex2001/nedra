...
`POST /notifications/read-all` — все или только по заявкам из
`expertise_ids`. Второй вариант нужен кабинету: открыл вкладку «Входящие» —
уведомления по входящим заявкам прочитаны, бейдж погас, а на вкладке
«Уведомления» остальное лежит непрочитанным, пока не нажали кнопку.
