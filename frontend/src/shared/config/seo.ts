...
export const PAGE_SEO: Record<string, PageSeo> = {
  ...
  "/blog": {
    title: "Блог — статьи о промышленной безопасности, проектировании и экспертизе",
    description:
      "Блог НПИ «Недра»: разбор законодательства, промышленная безопасность, проектирование, экспертиза и практика работы с опасными производственными объектами.",
  },
