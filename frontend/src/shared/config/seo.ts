...
export const PAGE_SEO: Record<string, PageSeo> = {
  ...
  "/novosti": {
    title: "Новости — изменения законодательства, Ростехнадзор, проектирование и экспертиза",
    description:
  ...
  // "/blits-ekspert": {
  //   title: "Блиц-эксперт — экспертиза промышленной безопасности за 1–5 дней",
  //   description:
  ...
  "/registratsiya-eksperta": {
    ...
    description:
      "Заявка на регистрацию эксперта в НПИ «Недра»: области аттестации, объекты экспертизы, категория и удостоверения. Проверка документов и доступ в личный кабинет.",
  },
