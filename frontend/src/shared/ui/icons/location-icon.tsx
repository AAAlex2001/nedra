...
export const LocationIcon = ({ className }: IconProps) => (
  ...
  >
    ...
    />
    <path
      d="M11.42 21.814C11.5894 21.9346 11.7921 21.9994 12 21.9994C12.2079 21.9994 12.4107 21.9346 12.58 21.814C12.884 21.599 20.029 16.44 20 10C20 5.589 16.411 2 12 2C7.58903 2 4.00003 5.589 4.00003 9.995C3.97103 16.44 11.116 21.599 11.42 21.814ZM12 4C15.309 4 18 6.691 18 10.005C18.021 14.443 13.612 18.428 12 19.735C10.389 18.427 5.97903 14.441 6.00003 10C6.00003 6.691 8.69103 4 12 4Z"
      fill="#F69827"
    />
  </svg>
);
