...
const RegisterForm = ({ onSuccess, onSwitchToLogin, onClose }: RegisterFormProps) => {
  const { state, changeField, submit } = useRegisterForm(onSuccess);
    ...
    >
      ...
      <div className={styles.notice}>
        ...
        <p className={styles.noticeText}>
          Аккаунт эксперта заводит администратор после проверки удостоверений. Заполните
          заявку, обычно проверка занимает до двух рабочих дней.
        </p>
